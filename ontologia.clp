...
([i0r0] of INGREDIENTE_RECETA (id_ingrediente masa) (id_receta "Pizza 4 quesos")(paso ) (cantidad 190))
([i1r0] of INGREDIENTE_RECETA (id_ingrediente parmesano) (id_receta "Pizza 4 quesos")(paso ) (cantidad 80))
([i2r0] of INGREDIENTE_RECETA (id_ingrediente mozzarella) (id_receta "Pizza 4 quesos")(paso ) (cantidad 80))
([i3r0] of INGREDIENTE_RECETA (id_ingrediente queso_de_cabra) (id_receta "Pizza 4 quesos")(paso ) (cantidad 50))
([i4r0] of INGREDIENTE_RECETA (id_ingrediente roquefort) (id_receta "Pizza 4 quesos")(paso ) (cantidad 150))
)
...
([i0r1] of INGREDIENTE_RECETA (id_ingrediente masa) (id_receta "Pizza barbacoa")(paso ) (cantidad 80))
([i1r1] of INGREDIENTE_RECETA (id_ingrediente ternera) (id_receta "Pizza barbacoa")(paso ) (cantidad 80))
([i2r1] of INGREDIENTE_RECETA (id_ingrediente barbacoa) (id_receta "Pizza barbacoa")(paso ) (cantidad 140))
)
...
([i0r2] of INGREDIENTE_RECETA (id_ingrediente masa_integral) (id_receta "Pizza carbonara")(paso ) (cantidad 90))
([i1r2] of INGREDIENTE_RECETA (id_ingrediente pollo) (id_receta "Pizza carbonara")(paso ) (cantidad 180))
([i2r2] of INGREDIENTE_RECETA (id_ingrediente parmesano) (id_receta "Pizza carbonara")(paso ) (cantidad 180))
)
...
([i0r3] of INGREDIENTE_RECETA (id_ingrediente masa) (id_receta "Pizza jamon y queso")(paso ) (cantidad 160))
([i1r3] of INGREDIENTE_RECETA (id_ingrediente jamon_york) (id_receta "Pizza jamon y queso")(paso ) (cantidad 10))
([i2r3] of INGREDIENTE_RECETA (id_ingrediente mozzarella) (id_receta "Pizza jamon y queso")(paso ) (cantidad 20))
)
